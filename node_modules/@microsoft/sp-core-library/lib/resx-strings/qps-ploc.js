define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      "invalidEnvironmentTypeError": "[!!--##***ȆńvįŗőńmėňţŦɏƿȅ ış ıŉvāŀĩđ##--!!]",
      "invalidGuidStringError": "[!!--##***Įŉvȃĺįđ ĞŪĪƉ šţřĩňġ: \"{0}\"##--!!]",
      "isFalseValidateError": "[!!--##***Ţĥȇ vąĺųė ƒŏŗ \"{0}\" ıš ƒàļŝě##--!!]",
      "isNullValidateError": "[!!--##***Ťħė vãŀůĕ ƒőř \"{0}\" můšť ƞơţ Ƅȇ ŋũŀľ##--!!]",
      "isUndefinedValidateError": "[!!--##***Ţħē vȁłūė ƒōŕ \"{0}\" mūŝŧ ņōť ɓę ŭŉđēƒīƞĕđ##--!!]",
      "isEmptyStringValidateError": "[!!--##***Ťħě váļůě ƒŏŕ \"{0}\" műśť ŉơť ƃĕ ȁŋ ȅmƥţȳ şţŕīŋğ##--!!]",
      "isDisposedValidateError": "[!!--##***Ŧħĕ \"{0}\" ōƀĴēćţ ċâŉŋŏŧ Ƅĕ űşēđ ɓēċãųşē ĭŧ ĥąŝ ƅēěň đĭšƥőşėď.##--!!]",
      "invalidVersionStringError": "[!!--##***Īņvąļıđ vęŗşīőŉ śŧŕīƞĝ: \"{0}\"##--!!]",
      ...
      "serviceScopeConsumingBeforeFinished": "[!!--##***Ĉȃňņŏŧ čőŉŝűmȅ śėřvīćĕś ƅēćąũŝȅ ťĥę şĉơƥė īš ŉơť ƒĭŋĩšħěď ɏȅŧ##--!!]",
      "serviceScopeConsumingDuringAutoCreation": "[!!--##***Ĉàňňŏť ćơņšűmĕ şěřvĭĉĕś ďųřīŋģ ŞȇřvĩćěŚćōƥę ăųťŏĉŗėǻťīőƞ##--!!]",
      "serviceScopeAlreadyFinishedError": "[!!--##***Ŧħȇ ŜėřvĭċēŜčơƥě ĩŝ āĺŕěåďȳ ƒįŉīśĥĕď##--!!]",
